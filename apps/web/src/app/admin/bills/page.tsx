...
import { createBill } from "@/app/actions/admin-bills";
...
export default function AdminBillsPage() {
  ...
  async function submit() {
    ...
    setAmount("");
    alert("Bill/Charge created");
  }

  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-semibold">Bills & Charges (Monthly)</h1>
      ...
      <section className="rounded border bg-white p-4 space-y-3">
        ...
        <button className="rounded bg-black px-4 py-2 text-white" onClick={submit}>Create Bill</button>
      </section>
    </div>
  );
}
